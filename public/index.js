function PlusMinus(props) {
  ...
  return (
    <>
        <button id="plus" type="button" class="btn btn-light" onClick={(e) => handle(e)}> Plus </button>
        <button id="minus" type="button" class="btn btn-light" onClick={(e) => handle(e)}> Minus </button>
    </>
  )
}
...
function update(section, value) {
  //wrapping calls to server in promise
